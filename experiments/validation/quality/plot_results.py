...
def csv_paths(input_path: Path) -> tuple[Path, Path]:
    ...
    if input_path.name == CSV_DIRNAME:
        ...
        summary_path = root / CSV_DIRNAME / SUMMARY_FILENAME
        curves_path = root / CSV_DIRNAME / CURVES_FILENAME
...
def main() -> int:
    ...
    plots_dir = resolve_path(args.plot) if args.plot else root / PLOTS_DIRNAME
